...
| <a name="input_inline_policy_enabled"></a> [inline\_policy\_enabled](#input\_inline\_policy\_enabled) | Whether or not to enable an inline policy instead of a reusable managed policy | `bool` | `false` | no |
